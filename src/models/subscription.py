...
class Subscription(Base):
    ...
    Attributes:
        ...
        alert_type: Type of alert ('weekly_alerts', 'monthly_built_area', 'trimestral_alerts', or 'reporte_paramos')
    ...
    __table_args__ = (
        CheckConstraint(
            "alert_type IN ('weekly_alerts', 'monthly_built_area', 'trimestral_alerts', 'reporte_paramos')",
    ...
    def get_valid_alert_types(cls) -> list[str]:
        ...
        return ['weekly_alerts', 'monthly_built_area', 'trimestral_alerts', 'reporte_paramos']
